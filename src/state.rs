                ...
                .extend(
                    self.old_circles
                        ...
                        .map(|(index, mut circle)| {
                            if circle.position.sqr_length() > number!(1000000) {
                                println!("{index}: {:?} {:?}", circle.position, circle.velocity);
                            }
                            ...
                            'collision_checks: {
                                ...
                                for (other_index, other_circle) in
                                    self.old_circles.iter().enumerate()
                                {
